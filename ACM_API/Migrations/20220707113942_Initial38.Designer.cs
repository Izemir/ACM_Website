...
namespace ACM_API.Migrations
{
    ...
    [Migration("20220707113942_Initial38")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ACM_API.Models.Customer.SubCustomer", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("ChatSubCustomer", b =>
                {
                    b.Property<long>("ChatsId")
                        .HasColumnType("bigint");

                    b.Property<long>("SubCustomersId")
                        .HasColumnType("bigint");

                    b.HasKey("ChatsId", "SubCustomersId");

                    b.HasIndex("SubCustomersId");

                    b.ToTable("ChatSubCustomer");
                });
            ...
            modelBuilder.Entity("ACM_API.Models.Customer.SubCustomer", b =>
                {
                    b.HasOne("ACM_API.Models.Customer.ContactPerson", "ContactPerson")
                        .WithMany()
                        .HasForeignKey("ContactPersonId");
            ...
            modelBuilder.Entity("ACM_API.Models.User", b =>
                {
                    ...
                    b.HasOne("ACM_API.Models.Customer.SubCustomer", "SubCustomer")
                        .WithOne("User")
                        .HasForeignKey("ACM_API.Models.User", "SubCustomerId");
            ...
            modelBuilder.Entity("ACM_API.Models.UserFile", b =>
                {
                    ...
                    b.HasOne("ACM_API.Models.Order.Order", null)
                        .WithMany("Files")
            ...
            modelBuilder.Entity("ChatSubCustomer", b =>
                {
                    ...
                    b.HasOne("ACM_API.Models.Customer.SubCustomer", null)
                        .WithMany()
                        .HasForeignKey("SubCustomersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
